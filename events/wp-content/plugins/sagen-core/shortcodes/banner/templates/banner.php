    ...
    <div class="qodef-banner-text-holder" <?php echo sagen_select_get_inline_style($overlay_styles); ?>>
	    <div class="qodef-banner-text-outer">
		    <div class="qodef-banner-text-inner">
		        <?php if(!empty($title)) { ?>
		            <<?php echo esc_attr($title_tag); ?> class="qodef-banner-title" <?php echo sagen_select_get_inline_style($title_styles); ?>>
				...
				<?php if(!empty($subtitle)) { ?>
					<<?php echo esc_attr($subtitle_tag); ?> class="qodef-banner-subtitle" <?php echo sagen_select_get_inline_style($subtitle_styles); ?>>
