<div class="qodef-pie-chart-holder <?php echo esc_attr($holder_classes); ?>">
	...
	<?php if(!empty($title) || !empty($text)) { ?>
		<div class="qodef-pc-text-holder">
			<?php if(!empty($title)) { ?>
				<<?php echo esc_attr($title_tag); ?> class="qodef-pc-title" <?php echo sagen_select_get_inline_style($title_styles); ?>><?php echo esc_html($title); ?></<?php echo esc_attr($title_tag); ?>>
			<?php } ?>
			<?php if(!empty($text)) { ?>
