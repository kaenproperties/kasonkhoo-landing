<?php
namespace SagenCore\CPT\Shortcodes\ImageWithText;
...
class ImageWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image With Text', 'sagen-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Behavior', 'sagen-core' ),
							'value'      => array(
								esc_html__( 'None', 'sagen-core' )             => '',
								esc_html__( 'Open Lightbox', 'sagen-core' )    => 'lightbox',
								esc_html__( 'Open Custom Link', 'sagen-core' ) => 'custom-link',
								esc_html__( 'Zoom', 'sagen-core' )             => 'zoom',
								esc_html__( 'Grayscale', 'sagen-core' )        => 'grayscale'
							)
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'custom_link',
							'heading'    => esc_html__( 'Custom Link', 'sagen-core' ),
							'dependency' => Array( 'element' => 'image_behavior', 'value' => array( 'custom-link' ) )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'custom_link_target',
							'heading'    => esc_html__( 'Custom Link Target', 'sagen-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = sagen_core_get_shortcode_module_template_part( 'templates/image-with-text', 'image-with-text', '', $params );
