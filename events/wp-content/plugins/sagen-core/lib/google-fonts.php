<?php
if ( ! function_exists( 'sagen_select_init_google_fonts_array' ) ) {
    function sagen_select_init_google_fonts_array() {
...
';
        ...
        $sagen_select_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'sagen_select_init_google_fonts_array');
}