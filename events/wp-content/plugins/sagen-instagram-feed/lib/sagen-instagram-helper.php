...
/**
 * Class SagenInstagramHelper
 */
class SagenInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines sagen_instagram_image_atts filter
     *
    ...
    public function getImageHTML( $image ) {
        ...
        $imageAtts = apply_filters( 'sagen_instagram_image_atts',
            array(
