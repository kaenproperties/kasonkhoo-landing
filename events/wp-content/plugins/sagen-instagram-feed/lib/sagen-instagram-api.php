...
include 'sagen-instagram-helper.php';

/**
 * Class SagenInstagramApi
 */
class SagenInstagramApi {
    ...
    const INSTAGRAM_CODE = 'sagen_instagram_code';
    const INSTAGRAM_USER_ID = 'sagen_instagram_user_id';
    const INSTAGRAM_TOKEN = 'sagen_instagram_access_token';
    const INSTAGRAM_TOKEN_LONG_LIVED = 'sagen_instagram_access_token_long_lived';
    const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'sagen_instagram_access_token_long_lived_time';

    const FACEBOOK_CODE = 'sagen_facebook_code';
    const FACEBOOK_TOKEN = 'sagen_facebook_access_token';

    const CONNECTION_TYPE = 'sagen_connection_type';
    ...
    public function __construct() {
        ...
        $this->helper = new SagenInstagramHelper();
    }
     ...
     *
     * @see SagenInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see SagenInstagramApi::instagramExchangeCodeForToken()
     */
