...
class HeaderStandard extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$menu_area_position                     = sagen_select_get_meta_field_intersect( 'set_menu_area_position', $page_id );
		...
		$parameters = apply_filters( 'sagen_select_filter_header_standard_parameters', $parameters );
