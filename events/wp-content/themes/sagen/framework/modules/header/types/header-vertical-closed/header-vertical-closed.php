...
class HeaderVerticalClosed extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		$parameters['holder_class'] = sagen_select_vertical_closed_header_holder_class();
		$parameters['vertical_closed_icon_class'] = sagen_select_get_vertical_closed_header_icon_class();
		
		$parameters = apply_filters( 'sagen_select_filter_header_vertical_closed_parameters', $parameters );
	...
	public function getPerPageJSVariables( $perPageVars ) {
        ...
        $perPageVars['qodefHeaderVerticalWidth'] = 70;
