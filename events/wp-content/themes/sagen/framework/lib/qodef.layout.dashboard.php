...
/*
   Class: SagenSelectClassDashboardForm
   A class that initializes Select Dashboard Container
*/

class SagenSelectClassDashboardForm implements iSagenSelectInterfaceLayoutNode, iSagenSelectInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: SagenSelectClassDashboardGroup
   A class that initializes SagenSelectClass Group Field
*/
class SagenSelectClassDashboardGroup implements iSagenSelectInterfaceLayoutNode, iSagenSelectInterfaceRender {
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: SagenSelectClassDashboardTitle
   A class that initializes Dashboard Title
*/
class SagenSelectClassDashboardTitle implements iSagenSelectInterfaceRender {
	private $name;
	private $title;
	private $args = array();
...
/*
   Class: SagenSelectClassDashboardField
   A class that initializes SagenSelectClass Front Field
*/
class SagenSelectClassDashboardField implements iSagenSelectInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class SagenSelectClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class SagenSelectClassDashboardFieldText extends SagenSelectClassDashboardFieldType {
...
class SagenSelectClassDashboardFieldTextArea extends SagenSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class SagenSelectClassDashboardFieldImage extends SagenSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
			...
			<div class="qodef-dashboard-gallery-holder">
				<ul class="qodef-dashboard-gallery-images-holder">
					<?php if ( isset( $value_html ) ) {
						echo sagen_select_get_module_part( $value_html );
					} ?>
				</ul>
				<div class="qodef-dashboard-gallery-uploader">
					<?php
					if ( sagen_membership_theme_installed() ) {
						echo sagen_select_get_button_html( array(
							'text'         => esc_html__( 'Upload', 'sagen' ),
							'custom_class' => 'qodef-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="qodef-btn qodef-btn-medium qodef-btn-solid qodef-dashboard-gallery-upload"><span class="qodef-btn-text">' . esc_html__( 'Upload', 'sagen' ) . '</span></a>';
					} ?>
					...
					<?php if ( $value !== '' && $value !== false ) { ?>
						<button class="qodef-btn qodef-btn-solid qodef-dashboard-remove-image"><?php esc_html_e( 'Remove Media', 'sagen' ); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class SagenSelectClassDashboardFieldGallery extends SagenSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class SagenSelectClassDashboardFieldSelect extends SagenSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$class = '';
...
class SagenSelectClassDashboardFieldDate extends SagenSelectClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class SagenSelectClassDashboardFieldIcon extends SagenSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = sagen_select_icon_collections()->getIconCollectionsEmpty();
...
class SagenSelectClassDashboardFieldColor extends SagenSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		if ( ! empty( $repeat ) && array_key_exists( 'name', $repeat ) && array_key_exists( 'index', $repeat ) ) {
			$id   = $name . '-' . $repeat['index'];
			$name = $repeat['name'] . '[' . $repeat['index'] . '][' . $name . ']';
...
class SagenSelectClassDashboardFieldCheckBoxGroup extends SagenSelectClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class SagenSelectClassDashboardFieldAddress extends SagenSelectClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
...
class SagenSelectClassDashboardRepeater implements iSagenSelectInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
			...
			<?php if ( $this->table_layout ) { ?>
				<div class="qodef-dashboard-repeater-table-heading">
					<div class="qodef-dashboard-repeater-fields-holder">
						<div class="qodef-dashboard-repeater-table-cell qodef-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'sagen' ) ?></div>
						...
						<div class="qodef-dashboard-repeater-table-cell qodef-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'sagen' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class SagenSelectClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new SagenSelectClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'textarea':
				$field = new SagenSelectClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'date':
				$field = new SagenSelectClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new SagenSelectClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'gallery':
				$field = new SagenSelectClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new SagenSelectClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new SagenSelectClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new SagenSelectClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'checkboxgroup':
				$field = new SagenSelectClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'address':
				$field = new SagenSelectClassDashboardFieldAddress();
