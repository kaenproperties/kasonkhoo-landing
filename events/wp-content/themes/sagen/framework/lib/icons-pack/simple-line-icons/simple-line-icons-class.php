...
if ( ! function_exists( 'sagen_select_add_simple_line_icon_pack' ) ) {
	function sagen_select_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new SagenSelectClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'sagen_select_filter_add_icon_pack_into_collection', 'sagen_select_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'sagen_select_add_simple_line_icon_pack_option' ) ) {
	function sagen_select_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'sagen' );
		
		return $options;
	}
	
	add_filter( 'sagen_select_filter_add_icon_pack_into_options', 'sagen_select_add_simple_line_icon_pack_option' );
	add_filter( 'sagen_select_filter_add_icon_pack_into_social_options', 'sagen_select_add_simple_line_icon_pack_option' );
}

class SagenSelectClassSimpleLineIcons implements iSagenSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = SAGEN_SELECT_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'sagen'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'sagen'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'sagen'),
            'icon-social-facebook'    => esc_html__('Facebook', 'sagen'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'sagen'),
            'icon-social-github'      => esc_html__('Github', 'sagen'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'sagen'),
            'icon-social-instagram'   => esc_html__('Instagram', 'sagen'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'sagen'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'sagen'),
            'icon-social-reddit'      => esc_html__('Reddit', 'sagen'),
            'icon-social-skype'       => esc_html__('Skype', 'sagen'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'sagen'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'sagen'),
            'icon-social-spotify'     => esc_html__('Spotify', 'sagen'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'sagen'),
            'icon-social-twitter'     => esc_html__('Twitter', 'sagen'),
            'icon-social-youtube'     => esc_html__('Youtube', 'sagen')
        );
    }
