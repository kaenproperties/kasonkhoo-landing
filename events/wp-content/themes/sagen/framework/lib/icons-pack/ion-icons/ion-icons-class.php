...
if ( ! function_exists( 'sagen_select_add_ion_icon_pack' ) ) {
	function sagen_select_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new SagenSelectClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'sagen_select_filter_add_icon_pack_into_collection', 'sagen_select_add_ion_icon_pack' );
}

if ( ! function_exists( 'sagen_select_add_ion_icon_pack_option' ) ) {
	function sagen_select_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'sagen' );
		
		return $options;
	}
	
	add_filter( 'sagen_select_filter_add_icon_pack_into_options', 'sagen_select_add_ion_icon_pack_option' );
	add_filter( 'sagen_select_filter_add_icon_pack_into_social_options', 'sagen_select_add_ion_icon_pack_option' );
}

class SagenSelectClassIonIcons implements iSagenSelectInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = SAGEN_SELECT_FRAMEWORK_ICONS_ROOT . '/ion-icons/css/ionicons.min.css';
	}
