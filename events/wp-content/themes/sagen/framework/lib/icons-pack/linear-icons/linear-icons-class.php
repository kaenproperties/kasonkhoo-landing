...
if ( ! function_exists( 'sagen_select_add_linear_icon_pack' ) ) {
	function sagen_select_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new SagenSelectClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'sagen_select_filter_add_icon_pack_into_collection', 'sagen_select_add_linear_icon_pack' );
}

if ( ! function_exists( 'sagen_select_add_linear_icon_pack_option' ) ) {
	function sagen_select_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'sagen' );
		
		return $options;
	}
	
	add_filter( 'sagen_select_filter_add_icon_pack_into_options', 'sagen_select_add_linear_icon_pack_option' );
}

class SagenSelectClassLinearIcons implements iSagenSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = SAGEN_SELECT_FRAMEWORK_ICONS_ROOT . '/linear-icons/style.css';
	}
