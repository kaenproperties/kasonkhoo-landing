...
if ( ! function_exists( 'sagen_select_add_font_elegant_icon_pack' ) ) {
	function sagen_select_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new SagenSelectClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'sagen_select_filter_add_icon_pack_into_collection', 'sagen_select_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'sagen_select_add_font_elegant_icon_pack_option' ) ) {
	function sagen_select_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'sagen' );
		
		return $options;
	}
	
	add_filter( 'sagen_select_filter_add_icon_pack_into_options', 'sagen_select_add_font_elegant_icon_pack_option' );
	add_filter( 'sagen_select_filter_add_icon_pack_into_social_options', 'sagen_select_add_font_elegant_icon_pack_option' );
}

class SagenSelectClassIconsFontElegant implements iSagenSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = SAGEN_SELECT_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
