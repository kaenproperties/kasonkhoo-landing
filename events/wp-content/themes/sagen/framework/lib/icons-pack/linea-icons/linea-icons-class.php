...
if ( ! function_exists( 'sagen_select_add_linea_icon_pack' ) ) {
	function sagen_select_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new SagenSelectClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'sagen_select_filter_add_icon_pack_into_collection', 'sagen_select_add_linea_icon_pack' );
}

if ( ! function_exists( 'sagen_select_add_linea_icon_pack_option' ) ) {
	function sagen_select_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'sagen' );
		
		return $options;
	}
	
	add_filter( 'sagen_select_filter_add_icon_pack_into_options', 'sagen_select_add_linea_icon_pack_option' );
}

class SagenSelectClassLineaIcons implements iSagenSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = SAGEN_SELECT_FRAMEWORK_ICONS_ROOT . '/linea-icons/style.css';
	}
